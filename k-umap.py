...
def k_umap(dados):
    ...
    for dist_row in range(n):
        func = lambda sigma: k(prob_high_dim(dist, rho, sigma, dist_row))
        # Here use the adaptive neighborhoods!
...
#X = skdata.load_iris()                                                 # 15
#X = skdata.fetch_openml(name='penguins', version=1)                    # 15
#X = skdata.fetch_openml(name='mfeat-karhunen', version=1)              # 15
#X = skdata.fetch_openml(name='Olivetti_Faces', version=1)              # 15
#X = skdata.fetch_openml(name='AP_Breast_Colon', version=1)             # 15
#X = skdata.fetch_openml(name='page-blocks', version=1)                 # 15
#X = skdata.fetch_openml(name='Kuzushiji-MNIST', version=1)             # 15
#X = skdata.fetch_openml(name='optdigits', version=1)                   # 15
#X = skdata.fetch_openml(name='synthetic_control', version=1)           # 15
#X = skdata.fetch_openml(name='har', version=1)                         # 15
#X = skdata.fetch_openml(name='schizo', version=1)                      # 15
#X = skdata.fetch_openml(name='11_Tumors', version=1)                   # 15
#X = skdata.fetch_openml(name='one-hundred-plants-margin', version=1)   # 15
#X = skdata.fetch_openml(name='USPS', version=2)                        # 15
#X = skdata.fetch_openml(name='texture', version=1)                     # 15
#X = skdata.fetch_openml(name='Fashion-MNIST', version=1)               # 15
#X = skdata.fetch_openml(name='cnae-9', version=1)                      # 15
#X = skdata.fetch_openml(name='Prostate', version=1)                    # 15
#X = skdata.fetch_openml(name='steel-plates-fault', version=1)          # 15
#X = skdata.fetch_openml(name='BurkittLymphoma', version=1)             # 15

# Number of neighbors = sqrt(n)
X = skdata.load_digits()                                                # sqrt
#X = skdata.fetch_openml(name='mfeat-fourier', version=1)               # sqrt
#X = skdata.fetch_openml(name='mfeat-factors', version=1)               # sqrt
#X = skdata.fetch_openml(name='semeion', version=1)                     # sqrt
#X = skdata.fetch_openml(name='micro-mass', version=1)                  # sqrt
#X = skdata.fetch_openml(name='MNIST_784', version=1)                   # sqrt
#X = skdata.fetch_openml(name='pendigits', version=1)                   # sqrt
#X = skdata.fetch_openml(name='satimage', version=1)                    # sqrt
#X = skdata.fetch_openml(name='dilbert', version=1)                     # sqrt
#X = skdata.fetch_openml(name='gina_agnostic', version=1)               # sqrt
#X = skdata.fetch_openml(name='vowel', version=1)                       # sqrt
#X = skdata.fetch_openml(name='cars', version=1)                        # sqrt
#X = skdata.fetch_openml(name='UMIST_Faces_Cropped', version=1)         # sqrt
#X = skdata.fetch_openml(name='gas-drift', version=1)                   # sqrt
#X = skdata.fetch_openml(name='gisette', version=1)                     # sqrt
#X = skdata.fetch_openml(name='OVA_Breast', version=1)                  # sqrt
#X = skdata.fetch_openml(name='ionosphere', version=1)                  # sqrt
#X = skdata.fetch_openml(name='LED-display-domain-7digit', version=1)   # sqrt
#X = skdata.fetch_openml(name='yeast', version=1)                       # sqrt
#X = skdata.fetch_openml(name='Diabetes130US', version=1)               # sqrt
...
# Plota dados de saída
PlotaDados(dados_k_umap, target, 'SH-UMAP')
